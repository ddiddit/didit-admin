  ...
  <DashboardLayout>
    ...
    <div class="flex min-h-full justify-center pt-10">
      <div class="w-full max-w-2xl space-y-5">
        ...
        <!-- 헤더 -->
        <div>
          <h2 class="text-heading2 font-semibold text-grey-13">앱 설정</h2>
          <p class="mt-0.5 text-label1 text-grey-7">점검 모드 및 강제 업데이트를 관리합니다.</p>
        </div>
        ...
        <div class="bg-surface rounded-2xl border border-grey-5 px-6 py-5 space-y-4">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-caption1 text-grey-7 mt-0.5">활성화 시 모든 앱 사용자에게 점검 화면이 표시됩니다.</p>
            </div>
            <button
              type="button"
